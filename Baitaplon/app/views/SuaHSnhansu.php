...
<body>
    ...
    <form id="form-sua-nv" autocomplete="off">
        <div 
            class="coat"
            style="
                display: flex;
            ...
            >
                ...
                <div class="form-group mt-3">
                    ...
                    <input
                        ...
                        id="Manv"
                        class="form-control"
                        value="<?= htmlspecialchars($nhansu['Manv']) ?>"
                        readonly
                    />
                </div>
                <div class="form-group mt-3">
                    ...
                    <input
                        ...
                        id="Tennv"
                        class="form-control"
                        value="<?= htmlspecialchars($nhansu['Tennv']) ?>"
                        required
                    />
                </div>
                <div class="form-group mt-3">
                    ...
                    <input
                        ...
                        id="Sodt"
                        class="form-control"
                        value="<?= htmlspecialchars($nhansu['Sodt']) ?>"
                        required
                    />
                </div>
                <div class="form-group mt-3">
                    ...
                    <input
                        ...
                        id="Email"
                        class="form-control"
                        value="<?= htmlspecialchars($nhansu['Email']) ?>"
                        required
                    />
                </div>
                <div class="form-group mt-3">
                    ...
                    <input
                        ...
                        id="Diachi"
                        class="form-control"
                        value="<?= htmlspecialchars($nhansu['Diachi']) ?>"
                        required
                    />
                </div>
                <div class="form-group mt-3">
                    ...
                    <input
                        ...
                        id="Chucvu"
                        class="form-control"
                        value="<?= htmlspecialchars($nhansu['Chucvu']) ?>"
                        required
                    />    
                </div>
                <div class="form-group mt-3">
                    ...
                    <input
                        ...
                        id="Hocvi"
                        class="form-control"
                        value="<?= htmlspecialchars($nhansu['Hocvi']) ?>"
                        required
                    />    
                </div>
    ...
    <script>
    document.getElementById('form-sua-nv').addEventListener('submit', function(e) {
        e.preventDefault();
