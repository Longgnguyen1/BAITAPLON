    ...
    private function handleRequest()
    {
        ...
        if (!empty($urlArr) && $urlArr[0] === 'api') {
                    ...
                    switch ($method) {
                        ...
                        case 'PUT':
                            if (isset($params[0]) && $params[0] !== '') {
                                ...
                                $this->response404("Thiếu mã nhân viên để cập nhật.");
                                return;
                            }
                            break;
                        case 'DELETE':
                            if (isset($params[0]) && $params[0] !== '') {
                                ...
                                $this->response404("Thiếu mã nhân viên để xóa.");
                                return;
                            }
                            break;
                        default:
            ...
            if ($url === '/' || $url === '' || $url === '/login') {
                require_once 'app/controllers/web/login.php';
                exit;
            }
            if ($url === '/HSnhansu') {
                require_once 'app/controllers/web/HSnhansu.php';
                exit;
            }
            ...
            echo "404 Not Found<br>Trang không tồn tại.";
            exit;
        }
    }
